...
import Aguilar.Liz.AppcalculadoraCETES.databinding.ActivityMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnCalcular.setOnClickListener {
            ...
            if (cantidadStr.isBlank() || plazo == 0) {
                Toast.makeText(this, "Valores no validos, por favor ingrese valores válidos.", Toast.LENGTH_SHORT).show()
            } else {
